 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,Y){var q=N.length;N.push(Y);e:for(;0<q;){var he=q-1>>>1,De=N[he];if(0<r(De,Y))N[he]=Y,N[q]=De,q=he;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var Y=N[0],q=N.pop();if(q!==Y){N[0]=q;e:for(var he=0,De=N.length,Qe=De>>>1;he<Qe;){var je=2*(he+1)-1,Ke=N[je],K=je+1,ee=N[K];if(0>r(Ke,q))K<De&&0>r(ee,Ke)?(N[he]=ee,N[K]=q,he=K):(N[he]=Ke,N[je]=q,he=je);else if(K<De&&0>r(ee,q))N[he]=ee,N[K]=q,he=K;else break e}}return Y}function r(N,Y){var q=N.sortIndex-Y.sortIndex;return q!==0?q:N.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],c=[],f=1,u=null,h=3,p=!1,m=!1,y=!1,g=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(N){for(var Y=n(c);Y!==null;){if(Y.callback===null)i(c);else if(Y.startTime<=N)i(c),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(c)}}function A(N){if(y=!1,v(N),!m)if(n(l)!==null)m=!0,H(C);else{var Y=n(c);Y!==null&&ne(A,Y.startTime-N)}}function C(N,Y){m=!1,y&&(y=!1,d(I),I=-1),p=!0;var q=h;try{for(v(Y),u=n(l);u!==null&&(!(u.expirationTime>Y)||N&&!P());){var he=u.callback;if(typeof he=="function"){u.callback=null,h=u.priorityLevel;var De=he(u.expirationTime<=Y);Y=t.unstable_now(),typeof De=="function"?u.callback=De:u===n(l)&&i(l),v(Y)}else i(l);u=n(l)}if(u!==null)var Qe=!0;else{var je=n(c);je!==null&&ne(A,je.startTime-Y),Qe=!1}return Qe}finally{u=null,h=q,p=!1}}var E=!1,R=null,I=-1,w=5,S=-1;function P(){return!(t.unstable_now()-S<w)}function O(){if(R!==null){var N=t.unstable_now();S=N;var Y=!0;try{Y=R(!0,N)}finally{Y?B():(E=!1,R=null)}}else E=!1}var B;if(typeof x=="function")B=function(){x(O)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,j=X.port2;X.port1.onmessage=O,B=function(){j.postMessage(null)}}else B=function(){g(O,0)};function H(N){R=N,E||(E=!0,B())}function ne(N,Y){I=g(function(){N(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){m||p||(m=!0,H(C))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(h){case 1:case 2:case 3:var Y=3;break;default:Y=h}var q=h;h=Y;try{return N()}finally{h=q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,Y){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var q=h;h=N;try{return Y()}finally{h=q}},t.unstable_scheduleCallback=function(N,Y,q){var he=t.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?he+q:he):q=he,N){case 1:var De=-1;break;case 2:De=250;break;case 5:De=1073741823;break;case 4:De=1e4;break;default:De=5e3}return De=q+De,N={id:f++,callback:Y,priorityLevel:N,startTime:q,expirationTime:De,sortIndex:-1},q>he?(N.sortIndex=q,e(c,N),n(l)===null&&N===n(c)&&(y?(d(I),I=-1):y=!0,ne(A,q-he))):(N.sortIndex=De,e(l,N),m||p||(m=!0,H(C))),N},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(N){var Y=h;return function(){var q=h;h=Y;try{return N.apply(this,arguments)}finally{h=q}}}})(V0);G0.exports=V0;var Ty=G0.exports;/**
 * @license React
...
`)+`
`+d);const v=x+g+a,A=x+d+o,C=c0(r,r.VERTEX_SHADER,v),E=c0(r,r.FRAGMENT_SHADER,A);r.attachShader(y,C),r.attachShader(y,E),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function R(P){if(t.debug.checkShaderErrors){const O=r.getProgramInfoLog(y)||"",B=r.getShaderInfoLog(C)||"",X=r.getShaderInfoLog(E)||"",j=O.trim(),H=B.trim(),ne=X.trim();let N=!0,Y=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(N=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,C,E);else{const q=f0(r,C,"vertex"),he=f0(r,E,"fragment");Lt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
